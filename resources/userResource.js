...
UserResource.prototype.games = function(cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games?format=json')
    .then(function(data) {
...
UserResource.prototype.game_leagues = function(gameKeys, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=' + gameKeys.join(',') + '/leagues?format=json')
    .then(function(data) {
      var user = data.fantasy_content.users[0].user[0];
...
UserResource.prototype.game_teams = function(gameKeys, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=' + gameKeys.join(',') + '/teams?format=json')
    .then(function(data) {
      var user = data.fantasy_content.users[0].user[0];
