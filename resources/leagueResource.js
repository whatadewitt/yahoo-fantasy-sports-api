...
LeagueResource.prototype.meta = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/metadata?format=json')
    .then(function(data) {
...
LeagueResource.prototype.settings = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/settings?format=json')
    .then(function(data) {
...
LeagueResource.prototype.standings = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/standings?format=json')
    .then(function(data) {
...
LeagueResource.prototype.scoreboard = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/scoreboard?format=json')
    .then(function(data) {
...
LeagueResource.prototype.teams = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/teams?format=json')
    .then(function(data) {
...
LeagueResource.prototype.players = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/players?format=json')
    .then(function(data) {
...
LeagueResource.prototype.draft_results = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/draftresults?format=json')
    .then(function(data) {
...
LeagueResource.prototype.transactions = function(leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/transactions?format=json')
    .then(function(data) {
