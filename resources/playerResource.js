...
PlayerResource.prototype.meta = function(playerKey, cb) {
  ...
  this
    .api('http://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/metadata?format=json', 'GET', null)
    .then(function(data) {
...
PlayerResource.prototype.stats = function(playerKey, cb) {
  ...
  this
    .api('http://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/stats?format=json', 'GET', null)
    .then(function(data) {
...
PlayerResource.prototype.percent_owned = function(playerKey, cb) {
  ...
  this
    .api('http://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/percent_owned?format=json', 'GET', null)
    .then(function(data) {
...
PlayerResource.prototype.ownership = function(playerKey, leagueKey, cb) {
  ...
  this
    .api('http://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/players;player_keys=' + playerKey + '/ownership?format=json', 'GET', null)
    .then(function(data) {
...
PlayerResource.prototype.draft_analysis = function(playerKey, cb) {
  ...
  this
    .api('http://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/draft_analysis?format=json', 'GET', null)
    .then(function(data) {
