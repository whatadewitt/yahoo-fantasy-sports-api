...
GameResource.prototype.meta = function(gameKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/metadata?format=json')
    .then(function(data) {
...
GameResource.prototype.leagues = function(gameKey, leagueKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/leagues;league_keys=' + leagueKey.join(',') + '?format=json')
    .then(function(data) {
...
GameResource.prototype.players = function(gameKey, playerKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/players;player_keys=' + playerKey.join(',') + '?format=json')
    .then(function(data) {
...
GameResource.prototype.game_weeks = function(gameKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/game_weeks?format=json')
    .then(function(data) {
...
GameResource.prototype.stat_categories = function(gameKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/stat_categories?format=json')
    .then(function(data) {
...
GameResource.prototype.position_types = function(gameKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/position_types?format=json')
    .then(function(data) {
...
GameResource.prototype.roster_positions = function(gameKey, cb) {
  ...
  this
    .api('https://fantasysports.yahooapis.com/fantasy/v2/game/' + gameKey + '/roster_positions?format=json')
    .then(function(data) {
