...
GamesCollection.prototype.fetch = function() {
  ...
  this.yf.api(this.yf.GET, url, apiCallback);
};

GamesCollection.prototype._fetch_callback = function(
  cb,
  subresources,
  e,
  data
  ...
  var games = gameHelper.parseCollection(
...
GamesCollection.prototype._userFetch_callback = function(
  cb,
  subresources,
  e,
  data
