...
describe("resource: userResource", function() {
  ...
  it("should build a proper url to retrieve leagues a user plays in for a given game", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=328/leagues?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve leagues a user plays in for given games", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=328,242/leagues?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve teams a user owns in for a given game", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=328/teams?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve teams a user owns in for given games", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=328,242/teams?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
