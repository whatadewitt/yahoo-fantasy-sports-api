...
describe ("resource: playerResource", function() {
  ...
  it ("should build a proper url to retrieve metadata via a player key", function() {
    ...
    expect(yf.api)
      .toHaveBeenCalledWith("GET", "https://fantasysports.yahooapis.com/fantasy/v2/player/328.p.6619/metadata?format=json", jasmine.any(Function));
  });
  ...
  it ("should build a proper url to retrieve player stats via a player key", function() {
    ...
    expect(yf.api)
      .toHaveBeenCalledWith("GET", "https://fantasysports.yahooapis.com/fantasy/v2/player/328.p.6619/stats?format=json", jasmine.any(Function));
  });
  ...
  it ("should build a proper url to retrieve player ownership percentage via a player key", function() {
    ...
    expect(yf.api)
      .toHaveBeenCalledWith("GET", "https://fantasysports.yahooapis.com/fantasy/v2/player/328.p.6619/percent_owned?format=json", jasmine.any(Function));
  });
  ...
  it ("should build a proper url to retrieve player ownership in a given league via a player key and a league key", function() {
    ...
    expect(yf.api)
      .toHaveBeenCalledWith("GET", "https://fantasysports.yahooapis.com/fantasy/v2/league/328.l.34014/players;player_keys=328.p.6619/ownership?format=json", jasmine.any(Function));
  });
  ...
  it ("should build a proper url to retrieve player draft analysis via a player key", function() {
    ...
    expect(yf.api)
      .toHaveBeenCalledWith("GET", "https://fantasysports.yahooapis.com/fantasy/v2/player/328.p.6619/draft_analysis?format=json", jasmine.any(Function));
  });
});
