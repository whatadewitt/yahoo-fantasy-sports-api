...
describe("resource: teamResource", function() {
  ...
  it("should build a proper url to retrieve metadata via a team key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/metadata?format=json",
  ...
  it("should build a proper url to retrieve team stats via a team key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/stats?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve team standings via a team key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/standings?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve team ownership in a given league via a team key and a league key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/roster?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve team draft analysis via a team key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/draftresults?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
  ...
  it("should build a proper url to retrieve team draft analysis via a team key", function(done) {
    ...
    expect(yf.api).toHaveBeenCalledWith(
      {
        method: "GET",
        url: "https://fantasysports.yahooapis.com/fantasy/v2/team/328.l.34014.t.1/matchups?format=json",
        responseMapper: jasmine.any(Function)
      },
      jasmine.any(Function));
  });
