...
class TransactionResource {
  ...
  private putTransaction(
    ...
    return withCallback(
      this.yf.api(this.yf.PUT, url, body) as Promise<any>,
      cb,
    );
  }
  ...
  private respondWithOptionalNote(
    transactionKey: string,
    ...
    return this.respond(transactionKey, action, options, callback);
  }
  ...
  accept(
    ...
    return this.respondWithOptionalNote(transactionKey, "accept", opts, cb);
  }
  ...
  reject(
    ...
    return this.respondWithOptionalNote(transactionKey, "reject", opts, cb);
  }
  ...
  edit_trade(
    ...
    return this.putTransaction(
      transactionKey,
      buildEditTradePayload(transactionKey, opts),
      cb,
    );
  }
