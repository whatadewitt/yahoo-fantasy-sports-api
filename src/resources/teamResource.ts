...
class TeamResource {
  ...
  standings(teamKey: string): Promise<Team & { standings: any }>;
  standings(teamKey: string, cb: Callback<Team & { standings: any }>): void;
  standings(
    teamKey: string,
    cb?: Callback<Team & { standings: any }>
  ): Promise<Team & { standings: any }> | void {
    const promise = this.yf.api(
      this.yf.GET,
  ...
  roster(
    teamKey: string,
    weekOrCb?: number | Callback<Roster>,
    cb?: Callback<Roster>
  ): Promise<Roster> | void {
  ...
  matchups(
    teamKey: string,
    weeksOrCb?: number[] | Callback<TeamMatchup[]>,
